...
/* =============================================================
  ...
  var PROFILES = {
    ...
    lucky_777:           { bgType:"rainbow",   chrome:"chrome_round", winFX:"fruit_pop",    coins:["\uD83C\uDF4A","\uD83C\uDF47","\uD83C\uDF53","\u2764"], anticipation:"sparkle",   intro:"flash" ,accentColor:"#FF0000",reelStyle:"spiral",ambientFx:"confetti"},
    ...
    black_bull:          { bgType:"arena",     chrome:"dark_iron",    winFX:"dust_cloud",   coins:["\uD83D\uDC02","\uD83D\uDCAB","\u2728","\uD83D\uDCB0"], anticipation:"rumble",      intro:"dramatic" ,accentColor:"#8B4513",reelStyle:"slam",ambientFx:"dust"},
    ...
    super_hot:{ bgType:"retro_glow",chrome:"chrome_round",winFX:"firework_pop",     coins:["\uD83C\uDF4A","\uD83D\uDD25","\u2B50","\u26A1"],       anticipation:"neon_flash",    intro:"neon" ,accentColor:"#FF00FF",reelStyle:"elastic",ambientFx:"sparkles"},
    ...
    big_bass:{ bgType:"deep_sea",chrome:"fishing",winFX:"splash",       coins:["\uD83D\uDC1F","\uD83D\uDC20","\u2B50","\uD83D\uDCB0"], anticipation:"wave_crash",  intro:"watery" ,accentColor:"#0077BE",reelStyle:"smooth",ambientFx:"bubbles"},
    fire_joker:{ bgType:"circus_fire",chrome:"jester",winFX:"ember_burst", coins:["\uD83C\uDCA1","\uD83C\uDCA0","\uD83D\uDD25","\uD83D\uDCB0"], anticipation:"spin_joker",intro:"carnival" ,accentColor:"#FF6B00",reelStyle:"spiral",ambientFx:"embers"},
    ...
    gonzos_quest:        { bgType:"jungle_ruins",chrome:"stone_aztec",winFX:"avalanche",    coins:["\uD83E\uDEBF","\uD83C\uDF0E","\u2728","\uD83D\uDCB0"], anticipation:"rumble",      intro:"epic" ,accentColor:"#FFD700",reelStyle:"cascade",ambientFx:"leaves"},
    ...
    olympus_rising:{ bgType:"olympus",chrome:"golden_gods",winFX:"solar_burst",coins:["\u26A1","\uD83D\uDC8E","\uD83D\uDCB0","\u2728"], anticipation:"star_glow",     intro:"epic" ,accentColor:"#FFC125",reelStyle:"slam",ambientFx:"sparkles"},
    ...
    puppy_palace:{ bgType:"rainbow",chrome:"chrome_round",winFX:"heart_pop",    coins:["\uD83D\uDC36","\u2764","\u2B50","\uD83D\uDCB0"],      anticipation:"sparkle",     intro:"sweet" ,accentColor:"#FFB6C1",reelStyle:"cascade",ambientFx:"confetti"},
    crimson_fang:{ bgType:"haunted",chrome:"dark_iron",winFX:"blood_burst",  coins:["\uD83E\uDDB7","\uD83D\uDD0E","\u2B50","\uD83D\uDCB0"], anticipation:"blood_pulse",  intro:"dark" ,accentColor:"#990000",reelStyle:"glitch",ambientFx:"smoke"},
    pirate_fortune:      { bgType:"ocean_wave",chrome:"pirate_wood",  winFX:"treasure_pop", coins:["\u2620","\uD83D\uDCB0","\u2693","\uD83D\uDC8E"],       anticipation:"pirate_warn",  intro:"pirate" ,accentColor:"#DEB887",reelStyle:"wave",ambientFx:"bubbles"},
    lucky_dragon:{ bgType:"chinese_sky",chrome:"gold_ornate",winFX:"lightning_strike", coins:["\uD83D\uDC09","\uD83C\uDF81","\u2728","\uD83D\uDCB0"], anticipation:"dragon_glow", intro:"epic" ,accentColor:"#FF6347",reelStyle:"smooth",ambientFx:"petals"},
    pharaoh_legacy:{ bgType:"egypt_dusk",chrome:"gold_ornate",winFX:"gold_shower",   coins:["\uD83C\uDFFA","\u2728","\uD83D\uDCB0","\uD83D\uDC8E"], anticipation:"sand_storm",  intro:"ancient" ,accentColor:"#FFD700",reelStyle:"smooth",ambientFx:"sand"},
    ...
    twin_helix:          { bgType:"cyber_grid",chrome:"tech_hud",     winFX:"dna_spiral",   coins:["\uD83E\uDDEC","\u26A1","\u2728","\uD83D\uDCB0"],       anticipation:"neon_flash",    intro:"cosmic" ,accentColor:"#00FF00",reelStyle:"glitch",ambientFx:"sparkles"},
    ...
    island_tiki:         { bgType:"tropical",  chrome:"bamboo",       winFX:"tropical_pop", coins:["\uD83C\uDF34","\uD83C\uDF3A","\uD83D\uDCB0","\u2728"], anticipation:"jungle_drum",  intro:"jungle" ,accentColor:"#FF8C00",reelStyle:"bounce",ambientFx:"bubbles"},
    sakura_princess:     { bgType:"sakura_sky",chrome:"kawaii_pink",  winFX:"sakura_burst", coins:["\uD83C\uDF38","\u2B50","\uD83C\uDF1F","\uD83D\uDCB0"], anticipation:"pulse_pink",     intro:"mystic" ,accentColor:"#FF69B4",reelStyle:"flutter",ambientFx:"petals"},
    ares_blade:          { bgType:"arena",     chrome:"dark_iron",    winFX:"sword_clash",  coins:["\u2694","\uD83D\uDC80","\u2728","\uD83D\uDCB0"],        anticipation:"pulse_red",  intro:"dramatic" ,accentColor:"#DC143C",reelStyle:"turbo",ambientFx:"dust"},
    neon_nights:         { bgType:"neon_city", chrome:"arcade_neon",  winFX:"neon_pop",     coins:["\uD83C\uDF06","\u26A1","\uD83D\uDCB0","\u2728"],       anticipation:"electric",    intro:"neon" ,accentColor:"#FF1493",reelStyle:"turbo",ambientFx:"sparkles"},
    ...
    bass_splash:{ bgType:"ocean_ripple",chrome:"fishing",winFX:"bubble_burst",       coins:["\uD83D\uDC1F","\uD83C\uDF0A","\u2B50","\uD83D\uDCB0"], anticipation:"wave_crash",  intro:"watery" ,accentColor:"#87CEEB",reelStyle:"jelly",ambientFx:"bubbles"},
    ...
    esqueleto_fiesta:    { bgType:"day_dead",  chrome:"fiesta",       winFX:"confetti_pop", coins:["\uD83D\uDC80","\uD83C\uDF8A","\u2B50","\uD83D\uDCB0"], anticipation:"rumble",  intro:"carnival" ,accentColor:"#FFD700",reelStyle:"jelly",ambientFx:"confetti"},
    wildfire_gold:       { bgType:"wildfire",  chrome:"fire_border",  winFX:"ember_burst",  coins:["\uD83D\uDD25","\uD83D\uDCAB","\u2B50","\uD83D\uDCB0"], anticipation:"heat",        intro:"inferno" ,accentColor:"#FFD700",reelStyle:"elastic",ambientFx:"embers"},
    five_lions:{ bgType:"chinese_sky",chrome:"gold_ornate",winFX:"gold_shower", coins:["\uD83E\uDD81","\uD83C\uDF81","\u2728","\uD83D\uDCB0"], anticipation:"dragon_glow", intro:"epic" ,accentColor:"#FFD700",reelStyle:"spiral",ambientFx:"petals"},
    chilli_heat:         { bgType:"flames",    chrome:"fire_border",  winFX:"ember_burst",  coins:["\uD83C\uDF36","\uD83D\uDD25","\uD83C\uDF1F","\uD83D\uDCB0"], anticipation:"heat",        intro:"inferno" ,accentColor:"#FF0000",reelStyle:"thunder_drop",ambientFx:"embers"},
    ...
    mental_meltdown:     { bgType:"cyber_grid",chrome:"tech_hud",     winFX:"glitch_burst", coins:["\uD83E\uDDE0","\u26A1","\u2728","\uD83D\uDCB0"],       anticipation:"neon_flash",    intro:"cyber" ,accentColor:"#FF0000",reelStyle:"bounce",ambientFx:"sparkles"}
  };

  // Continue remaining 125 games
  var PROFILES2 = {
    street_rider:        { bgType:"city_rain",  chrome:"arcade_neon", winFX:"neon_pop",     coins:["\uD83D\uDEF4","\u26A1","\uD83D\uDCB0","\u2728"],       anticipation:"electric",    intro:"neon" ,accentColor:"#00FFFF",reelStyle:"smooth",ambientFx:"rain"},
    spartan_glory:{ bgType:"arena",chrome:"chrome_round",winFX:"sword_clash",  coins:["\uD83D\uDEE1","\u2694","\u2B50","\uD83D\uDCB0"],        anticipation:"rumble",     intro:"dramatic" ,accentColor:"#B8860B",reelStyle:"thunder_drop",ambientFx:"dust"},
    jungle_spirit:{ bgType:"deep_jungle",chrome:"bamboo",winFX:"magic_swirl",   coins:["\uD83C\uDF43","\uD83C\uDF40","\u2728","\uD83D\uDCB0"], anticipation:"jungle_drum",     intro:"jungle" ,accentColor:"#00AA00",reelStyle:"bounce",ambientFx:"leaves"},
    wild_west:{ bgType:"wild_west",chrome:"rustic_wood",winFX:"dust_cloud",  coins:["\uD83E\uDD20","\u2B50","\uD83D\uDCB0","\uD83D\uDC04"], anticipation:"rumble",      intro:"wild" ,accentColor:"#CD853F",reelStyle:"bounce",ambientFx:"sand"},
    mystic_gems:         { bgType:"crystal_cave",chrome:"gem_frame",  winFX:"gem_shatter",  coins:["\uD83D\uDC8E","\u2728","\uD83D\uDCAF","\uD83D\uDCB0"], anticipation:"gem_glow",    intro:"mystic" ,accentColor:"#BA55D3",reelStyle:"flutter",ambientFx:"crystals"},
    thunder_crash:       { bgType:"stormy_sky", chrome:"tech_hud",    winFX:"thunder_burst",coins:["\u26A1","\u2728","\uD83D\uDCB0","\uD83D\uDC8E"],        anticipation:"thunder",     intro:"dramatic" ,accentColor:"#FFFF00",reelStyle:"slam",ambientFx:"rain"},
    solar_blast:         { bgType:"space_nova", chrome:"tech_hud",    winFX:"solar_burst",  coins:["\u2600","\u26A1","\u2728","\uD83D\uDCB0"],              anticipation:"heat",    intro:"cosmic" ,accentColor:"#FFFF00",reelStyle:"gravity",ambientFx:"lightning"},
    ...
    amazon_wild:         { bgType:"deep_jungle",chrome:"bamboo",      winFX:"leaf_burst",   coins:["\uD83C\uDF3F","\uD83C\uDF43","\u2728","\uD83D\uDCB0"], anticipation:"jungle_drum",     intro:"jungle" ,accentColor:"#228B22",reelStyle:"jelly",ambientFx:"leaves"},
    treasure_hunt:{ bgType:"ocean_wave",chrome:"gold_ornate",winFX:"treasure_pop", coins:["\uD83D\uDCB0","\u2693","\u2620","\u2728"],              anticipation:"pirate_warn",  intro:"pirate" ,accentColor:"#DAA520",reelStyle:"flutter",ambientFx:"bubbles"},
    lucky_shamrock:      { bgType:"irish_green",chrome:"chrome_round",winFX:"shamrock_pop", coins:["\uD83C\uDF40","\u2618","\uD83D\uDCB0","\u2728"],       anticipation:"pulse_green",     intro:"flash" ,accentColor:"#00AA00",reelStyle:"cascade",ambientFx:"sparkles"},
    ice_queen:{ bgType:"blizzard",chrome:"crystal_ball",winFX:"ice_shatter",  coins:["\u2744","\u2745","\uD83D\uDC8E","\uD83D\uDCB0"],       anticipation:"frost_glow",      intro:"frozen" ,accentColor:"#B0E0E6",reelStyle:"gravity",ambientFx:"snow"},
    lava_gold:           { bgType:"volcano",    chrome:"fire_border", winFX:"lava_pop",     coins:["\uD83D\uDD25","\uD83E\uDEA8","\uD83D\uDCB0","\u2B50"], anticipation:"lava_glow",        intro:"inferno" ,accentColor:"#FF8C00",reelStyle:"slam",ambientFx:"ash"},
    moon_princess:       { bgType:"moonlit",    chrome:"kawaii_pink", winFX:"moon_burst",   coins:["\uD83C\uDF19","\u2B50","\uD83D\uDC8E","\uD83D\uDCB0"], anticipation:"moon_glow",   intro:"mystic" ,accentColor:"#FFB6D9",reelStyle:"gravity",ambientFx:"fireflies"},
    wild_amazon:{ bgType:"bamboo_forest",chrome:"bamboo",winFX:"leaf_burst",   coins:["\uD83C\uDF3F","\uD83C\uDF43","\u2B50","\uD83D\uDCB0"], anticipation:"jungle_drum",     intro:"jungle" ,accentColor:"#32CD32",reelStyle:"smooth",ambientFx:"leaves"},
    aztec_gold:          { bgType:"aztec_temple",chrome:"stone_aztec",winFX:"gold_shower",  coins:["\uD83D\uDCB0","\uD83C\uDF1E","\u2728","\uD83D\uDC8E"], anticipation:"sand_storm",      intro:"ancient" ,accentColor:"#C9A96E",reelStyle:"cascade",ambientFx:"dust"},
    monster_match:       { bgType:"haunted",    chrome:"dark_iron",   winFX:"slime_burst",  coins:["\uD83D\uDC7B","\uD83C\uDF83","\u2B50","\uD83D\uDCB0"], anticipation:"sparkle",  intro:"carnival" ,accentColor:"#FF6B00",reelStyle:"jelly",ambientFx:"smoke"},
    golden_tiger:{ bgType:"chinese_sky",chrome:"jade_frame",winFX:"gold_shower", coins:["\uD83D\uDC2F","\u2B50","\uD83D\uDCB0","\uD83D\uDC8E"], anticipation:"dragon_glow", intro:"epic" ,accentColor:"#FFB300",reelStyle:"cascade",ambientFx:"petals"},
    neon_future:         { bgType:"cyber_grid", chrome:"tech_hud",    winFX:"laser_pop",    coins:["\u26A1","\uD83D\uDD2C","\u2728","\uD83D\uDCB0"],        anticipation:"electric",    intro:"cyber" ,accentColor:"#00FFFF",reelStyle:"glitch",ambientFx:"lightning"},
    dark_knight:         { bgType:"gothic_city",chrome:"dark_iron",   winFX:"bat_burst",    coins:["\uD83E\uDDB7","\uD83C\uDF03","\u2728","\uD83D\uDCB0"], anticipation:"dark_pulse",  intro:"dark" ,accentColor:"#2F4F4F",reelStyle:"gravity",ambientFx:"smoke"},
    reef_riches:         { bgType:"coral_sea",  chrome:"fishing",     winFX:"bubble_burst", coins:["\uD83D\uDC1F","\uD83D\uDC20","\uD83D\uDC22","\uD83D\uDCB0"], anticipation:"wave_crash",intro:"watery" ,accentColor:"#00CED1",reelStyle:"wave",ambientFx:"crystals"},
    ninja_master:        { bgType:"ninja_dojo",  chrome:"dark_iron",  winFX:"shuriken_pop", coins:["\uD83E\uDD44","\u2694","\u2B50","\uD83D\uDCB0"],        anticipation:"pulse_red",  intro:"samurai" ,accentColor:"#2F4F4F",reelStyle:"turbo",ambientFx:"smoke"},
    fortune_tiger:{ bgType:"chinese_sky",chrome:"fire_border",winFX:"dragon_burst", coins:["\uD83D\uDC2F","\uD83C\uDF81","\u2728","\uD83D\uDCB0"], anticipation:"heat", intro:"epic" ,accentColor:"#FF4500",reelStyle:"gravity",ambientFx:"petals"},
    rainbow_gold:        { bgType:"rainbow",    chrome:"chrome_round",winFX:"rainbow_burst",coins:["\uD83C\uDF08","\uD83D\uDCB0","\u2728","\uD83D\uDC8E"], anticipation:"pulse_green",     intro:"flash" ,accentColor:"#FFD700",reelStyle:"elastic",ambientFx:"confetti"},
    wolf_moon:{ bgType:"moonlit",chrome:"ice_crystal",winFX:"moon_howl",    coins:["\uD83D\uDC3A","\uD83C\uDF19","\u2B50","\uD83D\uDCB0"], anticipation:"moon_glow",   intro:"dark" ,accentColor:"#E0E0FF",reelStyle:"flutter",ambientFx:"fireflies"},
    crystal_cavern:      { bgType:"crystal_cave",chrome:"ice_crystal",winFX:"crystal_pop",  coins:["\uD83D\uDC8E","\u2745","\u2728","\uD83D\uDCB0"],       anticipation:"crystal_ring",    intro:"mystic" ,accentColor:"#4DD0E1",reelStyle:"cascade",ambientFx:"crystals"},
    royal_flush:         { bgType:"velvet_casino",chrome:"gold_ornate",winFX:"card_shuffle", coins:["\u2660","\u2665","\uD83D\uDCB0","\u2728"],             anticipation:"royal_glow",   intro:"royal" ,accentColor:"#9400D3",reelStyle:"smooth",ambientFx:"sparkles"},
    phoenix_blaze:       { bgType:"phoenix_fire",chrome:"fire_border",winFX:"phoenix_burst",coins:["\uD83D\uDD25","\uD83D\uDCAB","\uD83D\uDCB0","\u2B50"], anticipation:"dragon_glow",        intro:"inferno" ,accentColor:"#FF4500",reelStyle:"flutter",ambientFx:"embers"},
    deep_sea_diver:      { bgType:"deep_sea",   chrome:"fishing",     winFX:"bubble_burst", coins:["\uD83D\uDC22","\uD83D\uDC1F","\uD83D\uDC8E","\uD83D\uDCB0"], anticipation:"pulse_blue",intro:"watery" ,accentColor:"#00688B",reelStyle:"gravity",ambientFx:"bubbles"},
    samurai_sword:{ bgType:"ninja_dojo",chrome:"jade_frame",winFX:"sword_clash",  coins:["\u2694","\uD83E\uDD44","\u2B50","\uD83D\uDCB0"],        anticipation:"pulse_red",  intro:"samurai" ,accentColor:"#DC143C",reelStyle:"slam",ambientFx:"smoke"}
  };
  ...
  var PROFILES3 = {
    ...
    lucky_panda:         { bgType:"bamboo_forest",chrome:"jade_frame",   winFX:"panda_pop",   coins:["\uD83D\uDC3C","\uD83C\uDF81","\u2728","\uD83D\uDCB0"], anticipation:"sparkle",     intro:"mystic" ,accentColor:"#FF4500",reelStyle:"bounce",ambientFx:"petals"},
    big_bad_wolf:        { bgType:"moonlit",     chrome:"rustic_wood",   winFX:"moon_howl",   coins:["\uD83D\uDC3A","\uD83C\uDF15","\uD83C\uDF32","\uD83D\uDCB0"], anticipation:"moon_glow",   intro:"dramatic" ,accentColor:"#708090",reelStyle:"wave",ambientFx:"fireflies"},
    red_tiger:{ bgType:"chinese_sky",chrome:"fire_border",winFX:"ember_burst",coins:["\uD83D\uDC2F","\u2728","\uD83D\uDCB0","\u2B50"],       anticipation:"dragon_glow", intro:"inferno" ,accentColor:"#CC0000",reelStyle:"jelly",ambientFx:"petals"},
    super_diamond:{ bgType:"crystal_cave",chrome:"chrome_round",winFX:"diamond_shatter",coins:["\uD83D\uDC8E","\uD83C\uDF1F","\u2728","\uD83D\uDCB0"], anticipation:"gem_glow", intro:"flash" ,accentColor:"#B0E0E6",reelStyle:"gravity",ambientFx:"crystals"},
    gold_rush:           { bgType:"wild_west",   chrome:"rustic_wood",   winFX:"gold_shower", coins:["\uD83E\uDD20","\uD83D\uDCB0","\u2728","\uD83D\uDC8E"], anticipation:"golden_aura",      intro:"flash" ,accentColor:"#FFD700",reelStyle:"elastic",ambientFx:"sand"},
    star_of_egypt:{ bgType:"egypt_dusk",chrome:"ancient_stone",winFX:"starburst",  coins:["\uD83C\uDF1F","\uD83C\uDFFA","\u2728","\uD83D\uDCB0"], anticipation:"star_glow",  intro:"ancient" ,accentColor:"#FFD700",reelStyle:"cascade",ambientFx:"sand"},
    sparta_warriors:{ bgType:"arena",chrome:"ancient_stone",winFX:"sword_clash", coins:["\uD83D\uDEE1","\u2694","\uD83D\uDC51","\uD83D\uDCB0"],        anticipation:"rumble",     intro:"dramatic" ,accentColor:"#CD853F",reelStyle:"elastic",ambientFx:"dust"},
    buffalo_hold:{ bgType:"savanna",chrome:"rustic_wood",winFX:"thunder_burst",  coins:["\uD83E\uDD8C","\uD83D\uDCAB","\u2B50","\uD83D\uDCB0"], anticipation:"rumble",      intro:"wild" ,accentColor:"#A0522D",reelStyle:"gravity",ambientFx:"dust"},
    ...
    ancient_alchemist:   { bgType:"mystic_mist", chrome:"crystal_ball",  winFX:"mystic_burst",coins:["\u2697","\u2728","\uD83D\uDCB0","\uD83D\uDD2E"],        anticipation:"cosmic_hum",     intro:"mystic" ,accentColor:"#7FFF00",reelStyle:"spiral",ambientFx:"mist"},
    thunder_titan:       { bgType:"stormy_sky",  chrome:"golden_gods",   winFX:"lightning_strike",coins:["\u26A1","\uD83D\uDCA5","\u2B50","\uD83D\uDCB0"], anticipation:"thunder",     intro:"dramatic" ,accentColor:"#FFFF00",reelStyle:"gravity",ambientFx:"rain"},
    carnival_chaos:{ bgType:"carnival",chrome:"fiesta",winFX:"confetti_pop",coins:["\uD83C\uDF86","\uD83C\uDF89","\u2728","\uD83D\uDCB0"], anticipation:"spin_joker",  intro:"carnival" ,accentColor:"#FF4500",reelStyle:"spiral",ambientFx:"sparkles"},
    safari_king:{ bgType:"savanna",chrome:"gold_ornate",winFX:"dust_cloud",  coins:["\uD83E\uDD81","\uD83D\uDCAB","\u2B50","\uD83D\uDCB0"], anticipation:"rumble",      intro:"jungle" ,accentColor:"#DEB887",reelStyle:"wave",ambientFx:"dust"},
    crystal_royals:      { bgType:"crystal_cave",chrome:"gem_frame",     winFX:"crystal_pop", coins:["\uD83D\uDC8E","\u2728","\uD83D\uDC51","\uD83D\uDCB0"], anticipation:"gem_glow",    intro:"mystic" ,accentColor:"#BA55D3",reelStyle:"smooth",ambientFx:"crystals"},
    infernal_depths:     { bgType:"hell_fire",   chrome:"dark_iron",     winFX:"lava_pop",    coins:["\uD83D\uDC80","\uD83D\uDD25","\uD83D\uDCAB","\uD83D\uDCB0"], anticipation:"lava_glow",  intro:"dark" ,accentColor:"#FF4500",reelStyle:"glitch",ambientFx:"embers"},
    rainbow_riches_quest:{ bgType:"rainbow",chrome:"chrome_round",winFX:"shamrock_pop",coins:["\uD83C\uDF40","\uD83C\uDF08","\uD83D\uDCB0","\u2728"],       anticipation:"pulse_green",     intro:"flash" ,accentColor:"#00FF00",reelStyle:"bounce",ambientFx:"stars"},
    steampunk_gears:     { bgType:"steam_factory",chrome:"tech_hud",     winFX:"gear_burst",  coins:["\u2699","\uD83D\uDD27","\u2728","\uD83D\uDCB0"],        anticipation:"electric",    intro:"flash" ,accentColor:"#B8860B",reelStyle:"elastic",ambientFx:"smoke"},
    ...
    arctic_frost:        { bgType:"blizzard",    chrome:"ice_crystal",   winFX:"ice_shatter", coins:["\u2744","\u2745","\u2B50","\uD83D\uDCB0"],       anticipation:"freeze",      intro:"frozen" ,accentColor:"#87CEEB",reelStyle:"smooth",ambientFx:"snow"},
    urban_rooftop:{ bgType:"city_rain",chrome:"chrome_round",winFX:"neon_pop",    coins:["\uD83C\uDF06","\u26A1","\uD83C\uDF03","\uD83D\uDCB0"],       anticipation:"neon_flash",    intro:"cyber" ,accentColor:"#00FFFF",reelStyle:"wave",ambientFx:"rain"},
    enchanted_maze:      { bgType:"fairy_forest",chrome:"kawaii_pink",   winFX:"fairy_pop",   coins:["\u2728","\uD83E\uDDDA","\uD83D\uDC8E","\uD83D\uDCB0"], anticipation:"sparkle",     intro:"mystic" ,accentColor:"#9370DB",reelStyle:"flutter",ambientFx:"sparkles"},
    samurai_honor:       { bgType:"ninja_dojo",  chrome:"dark_iron",     winFX:"sword_clash", coins:["\u2694","\uD83C\uDF38","\u2B50","\uD83D\uDCB0"],        anticipation:"pulse_red",  intro:"samurai" ,accentColor:"#DC143C",reelStyle:"magnetic",ambientFx:"smoke"},
    ...
    sinners_paradise:{ bgType:"hell_fire",chrome:"fire_border",winFX:"lava_pop",    coins:["\uD83D\uDD25","\uD83D\uDC80","\uD83D\uDCB0","\u2728"], anticipation:"dark_pulse",  intro:"dark" ,accentColor:"#DC143C",reelStyle:"thunder_drop",ambientFx:"ash"},
    midnight_burlesque:  { bgType:"velvet_club", chrome:"gold_ornate",   winFX:"feather_pop", coins:["\uD83E\uDE78","\uD83D\uDC83","\u2728","\uD83D\uDCB0"], anticipation:"dark_pulse",   intro:"dark" ,accentColor:"#FF1493",reelStyle:"smooth",ambientFx:"smoke"},
    absinthe_nights:     { bgType:"absinth_dream",chrome:"gold_ornate",  winFX:"smoke_burst", coins:["\uD83D\uDC80","\u2726","\u2728","\uD83D\uDCB0"],        anticipation:"cosmic_hum",  intro:"mystic" ,accentColor:"#7FFF00",reelStyle:"spiral",ambientFx:"smoke"},
    velvet_lounge:{ bgType:"velvet_club",chrome:"gold_ornate",winFX:"card_shuffle",coins:["\uD83C\uDCCF","\u2665","\uD83D\uDCB0","\u2728"],       anticipation:"royal_glow",   intro:"royal" ,accentColor:"#9400D3",reelStyle:"cascade",ambientFx:"smoke"},
    dark_desire:{ bgType:"city_rain",chrome:"dark_iron",winFX:"dark_burst",  coins:["\uD83D\uDC80","\uD83D\uDD25","\u2728","\uD83D\uDCB0"], anticipation:"dark_pulse",  intro:"dark" ,accentColor:"#8B008B",reelStyle:"flutter",ambientFx:"rain"},
    vice_city_jackpot:{ bgType:"neon_city",chrome:"neon_round",winFX:"confetti_pop",    coins:["\uD83C\uDF06","\uD83D\uDCB0","\u26A1","\u2728"],       anticipation:"neon_flash",    intro:"neon" ,accentColor:"#FF1493",reelStyle:"wave",ambientFx:"sparkles"},
    whiskey_barrel:{ bgType:"wild_west",chrome:"chrome_round",winFX:"gunshot_pop", coins:["\uD83C\uDF7A","\uD83E\uDD20","\uD83D\uDCB0","\u2728"], anticipation:"wild_pulse",      intro:"wild" ,accentColor:"#CD853F",reelStyle:"bounce",ambientFx:"dust"},
    black_market:        { bgType:"gothic_city", chrome:"dark_iron",     winFX:"dark_burst",  coins:["\uD83D\uDCB0","\uD83D\uDC80","\u2728","\u26A1"],       anticipation:"dark_pulse",  intro:"dark" ,accentColor:"#2F4F4F",reelStyle:"glitch",ambientFx:"rain"},
    serpent_temptation:  { bgType:"mystic_mist", chrome:"crystal_ball",  winFX:"smoke_burst", coins:["\uD83D\uDC0D","\u2728","\uD83D\uDCB0","\uD83D\uDC80"], anticipation:"dark_pulse",  intro:"mystic" ,accentColor:"#228B22",reelStyle:"flutter",ambientFx:"mist"},
    neon_underworld:     { bgType:"neon_city",   chrome:"arcade_neon",   winFX:"laser_pop",   coins:["\u26A1","\uD83D\uDCB0","\uD83C\uDF06","\u2728"],       anticipation:"neon_flash",    intro:"dark" ,accentColor:"#FF00FF",reelStyle:"turbo",ambientFx:"rain"},
    blood_ritual:        { bgType:"blood_moon",  chrome:"dark_iron",     winFX:"blood_burst", coins:["\uD83D\uDD25","\uD83D\uDC80","\u2728","\uD83D\uDCB0"], anticipation:"blood_pulse",  intro:"dark" ,accentColor:"#8B0000",reelStyle:"glitch",ambientFx:"blood_drip"},
    crypt_of_sins:       { bgType:"haunted",     chrome:"dark_iron",     winFX:"dark_burst",  coins:["\uD83D\uDC80","\uD83C\uDF83","\u2728","\uD83D\uDCB0"], anticipation:"blood_pulse",  intro:"dark" ,accentColor:"#660000",reelStyle:"glitch",ambientFx:"mist"},
    flesh_and_gold:      { bgType:"velvet_club", chrome:"gold_ornate",   winFX:"gold_shower", coins:["\uD83D\uDCB0","\u2728","\uD83D\uDC8E","\uD83D\uDC80"], anticipation:"dark_pulse",   intro:"dark" ,accentColor:"#DAA520",reelStyle:"gravity",ambientFx:"mist"},
    opium_den:{ bgType:"absinth_dream",chrome:"crystal_ball",winFX:"smoke_burst", coins:["\uD83D\uDCB0","\uD83D\uDD2E","\u2728","\uD83D\uDC80"], anticipation:"dark_pulse",  intro:"mystic" ,accentColor:"#9370DB",reelStyle:"jelly",ambientFx:"mist"},
    torture_chamber:     { bgType:"hell_fire",   chrome:"dark_iron",     winFX:"dark_burst",  coins:["\uD83D\uDC80","\u26D3","\u2728","\uD83D\uDCB0"], anticipation:"dark_pulse",  intro:"dark" ,accentColor:"#4A0000",reelStyle:"glitch",ambientFx:"ash"}
  };
  ...
  var PROFILES4 = {
    ...
    nitro_street:{ bgType:"neon_city",chrome:"chrome_round",winFX:"energy_pulse",     coins:["\uD83C\uDFCE","\uD83D\uDCA8","\u26A1","\uD83D\uDCB0"],       anticipation:"electric",    intro:"flash" ,accentColor:"#FF4500",reelStyle:"elastic",ambientFx:"rain"},
    wild_toro:           { bgType:"arena",        chrome:"fire_border",  winFX:"dust_cloud",   coins:["\uD83D\uDC02","\uD83C\uDF39","\u2728","\uD83D\uDCB0"],       anticipation:"rumble",      intro:"dramatic" ,accentColor:"#CC0000",reelStyle:"glitch",ambientFx:"dust"},
    jammin_fruits:{ bgType:"tropical",chrome:"chrome_round",winFX:"tropical_pop", coins:["\uD83C\uDF4D","\uD83C\uDF4E","\uD83C\uDF53","\uD83D\uDCB0"], anticipation:"sparkle", intro:"sweet" ,accentColor:"#FFA500",reelStyle:"cascade",ambientFx:"bubbles"},
    ...
    fat_rabbit:{ bgType:"sunshine",chrome:"kawaii_pink",winFX:"heart_pop",    coins:["\uD83D\uDC30","\uD83E\uDD55","\u2728","\uD83D\uDCB0"],       anticipation:"pulse_pink",     intro:"sweet" ,accentColor:"#FF69B4",reelStyle:"bounce",ambientFx:"sparkles"},
    ...
    lucha_mania:{ bgType:"circus_fire",chrome:"fiesta",winFX:"firework_pop", coins:["\uD83E\uDD3C","\uD83C\uDF1F","\u26A1","\uD83D\uDCB0"],       anticipation:"rumble",        intro:"carnival" ,accentColor:"#FF6B00",reelStyle:"bounce",ambientFx:"embers"},
    ...
    chaos_crew:          { bgType:"neon_city",    chrome:"neon_round",   winFX:"neon_pop",     coins:["\uD83E\uDD21","\uD83D\uDCA3","\u26A1","\uD83D\uDCB0"],       anticipation:"neon_flash",    intro:"neon" ,accentColor:"#FF00FF",reelStyle:"bounce",ambientFx:"rain"},
    le_bandit:           { bgType:"dark_vignette",chrome:"dark_iron",    winFX:"gold_shower",  coins:["\uD83C\uDFA9","\uD83D\uDCB0","\uD83D\uDC8E","\u2728"],       anticipation:"rumble",  intro:"dark" ,accentColor:"#FFD700",reelStyle:"smooth",ambientFx:"ash"},
    ...
    mega_joker:{ bgType:"carnival",chrome:"jester",winFX:"confetti_pop", coins:["\uD83C\uDCA0","\uD83C\uDCA1","\u2B50","\uD83D\uDCB0"],       anticipation:"spin_joker",  intro:"carnival" ,accentColor:"#9C27B0",reelStyle:"elastic",ambientFx:"petals"},
    crown_fire:          { bgType:"flames",       chrome:"golden_gods",  winFX:"ember_burst",  coins:["\uD83D\uDC51","\uD83D\uDD25","\uD83D\uDCB0","\u2728"],       anticipation:"heat",        intro:"dramatic" ,accentColor:"#FF8C00",reelStyle:"thunder_drop",ambientFx:"smoke"},
    ...
    goldstorm_ultra:{ bgType:"golden_sky",chrome:"gold_ornate",winFX:"gold_shower",  coins:["\uD83D\uDCB0","\uD83C\uDF1F","\u2728","\uD83D\uDC8E"],       anticipation:"golden_aura",   intro:"epic" ,accentColor:"#FFC125",reelStyle:"cascade",ambientFx:"coins_float"},
    ...
    merlin_power:        { bgType:"enchanted",    chrome:"stone_aztec",  winFX:"magic_swirl",  coins:["\uD83E\uDDD9","\u2728","\uD83D\uDD2E","\uD83D\uDCB0"],       anticipation:"star_glow",     intro:"mystic" ,accentColor:"#FFD700",reelStyle:"spiral",ambientFx:"fireflies"},
    coin_strike:         { bgType:"golden_sky",   chrome:"chrome_round", winFX:"gold_shower",  coins:["\uD83D\uDCB0","\u2728","\uD83C\uDF1F","\uD83D\uDC8E"],       anticipation:"golden_aura",   intro:"flash" ,accentColor:"#FFD700",reelStyle:"smooth",ambientFx:"coins_float"},
    ...
    snoop_dollars:       { bgType:"neon_city",    chrome:"tech_hud",     winFX:"gold_shower",  coins:["\uD83D\uDCB5","\uD83D\uDCB0","\u2728","\uD83C\uDF1F"],       anticipation:"sparkle",    intro:"neon" ,accentColor:"#FFD700",reelStyle:"spiral",ambientFx:"rain"},
    ...
    loki_loot:           { bgType:"enchanted",    chrome:"dark_iron",    winFX:"magic_swirl",  coins:["\uD83D\uDE08","\u2728","\u26A1","\uD83D\uDCB0"],             anticipation:"sparkle",  intro:"epic" ,accentColor:"#FFD700",reelStyle:"jelly",ambientFx:"fireflies"},
    ...
    fruit_party:         { bgType:"candy",        chrome:"neon_round",   winFX:"candy_burst",  coins:["\uD83C\uDF4E","\uD83C\uDF47","\uD83C\uDF4A","\uD83D\uDCB0"], anticipation:"sparkle",  intro:"sweet" ,accentColor:"#FF6347",reelStyle:"bounce",ambientFx:"confetti"},
    ...
    razor_shark:{ bgType:"northern_sea",chrome:"dark_iron",winFX:"splash",       coins:["\uD83E\uDD88","\uD83D\uDC1F","\u2728","\uD83D\uDCB0"],       anticipation:"freeze",  intro:"watery" ,accentColor:"#00BFFF",reelStyle:"wave",ambientFx:"mist"},
    ...
    tome_madness:{ bgType:"enchanted",chrome:"stone_aztec",winFX:"mystic_burst",  coins:["\uD83D\uDCD6","\uD83D\uDD2E","\u2728","\uD83D\uDCB0"],       anticipation:"dark_pulse",     intro:"mystic" ,accentColor:"#6A0DAD",reelStyle:"bounce",ambientFx:"fireflies"},
    ...
    coin_volcano:        { bgType:"volcano",      chrome:"fire_border",  winFX:"gold_shower",  coins:["\uD83C\uDF0B","\uD83D\uDCB0","\u2728","\uD83D\uDC8E"],       anticipation:"lava_glow",        intro:"inferno" ,accentColor:"#FFA500",reelStyle:"turbo",ambientFx:"lightning"},
    ...
    wild_safari:{ bgType:"savanna",chrome:"chrome_round",winFX:"feather_pop",   coins:["\uD83E\uDD81","\uD83E\uDD92","\u2728","\uD83D\uDCB0"],       anticipation:"rumble",      intro:"wild" ,accentColor:"#DEB887",reelStyle:"cascade",ambientFx:"ash"},
    wild_deep:{ bgType:"northern_sea",chrome:"fishing",winFX:"splash",       coins:["\uD83D\uDC19","\uD83D\uDC20","\u2728","\uD83D\uDCB0"],       anticipation:"pulse_blue",  intro:"watery" ,accentColor:"#00688B",reelStyle:"wave",ambientFx:"aurora"},
    ...
    golden_pharaoh:{ bgType:"egypt_dusk",chrome:"ancient_stone",winFX:"gold_shower",   coins:["\uD83C\uDFFA","\uD83D\uDCB0","\u2728","\uD83D\uDC8E"],       anticipation:"golden_aura",  intro:"ancient" ,accentColor:"#DAA520",reelStyle:"slam",ambientFx:"fireflies"},
    mystic_cauldron:{ bgType:"enchanted",chrome:"crystal_ball",winFX:"magic_swirl",  coins:["\uD83E\uDDE4","\uD83D\uDD2E","\u2728","\uD83D\uDCB0"],       anticipation:"cosmic_hum",     intro:"mystic" ,accentColor:"#6A0DAD",reelStyle:"spiral",ambientFx:"leaves"},
    ...
    mine_coins:          { bgType:"dark_vignette",chrome:"stone_aztec",  winFX:"gold_shower",  coins:["\u26CF","\uD83D\uDCB0","\uD83D\uDC8E","\u2728"],             anticipation:"sparkle",      intro:"flash" ,accentColor:"#FFD700",reelStyle:"gravity",ambientFx:"ash"},
    ...
    demon_chambers:{ bgType:"hell_fire",chrome:"dark_iron",winFX:"blood_burst",  coins:["\uD83D\uDE08","\uD83D\uDD25","\u2620","\uD83D\uDCB0"],       anticipation:"blood_pulse",  intro:"dark" ,accentColor:"#990000",reelStyle:"thunder_drop",ambientFx:"blood_drip"},
    ...
    crystal_chambers:    { bgType:"crystal_cave", chrome:"gem_frame",    winFX:"starburst",    coins:["\uD83D\uDC8E","\u2728","\uD83D\uDCA0","\uD83D\uDCB0"],       anticipation:"crystal_ring",   intro:"mystic" ,accentColor:"#B0E0E6",reelStyle:"bounce",ambientFx:"mist"},
    jade_temple:{ bgType:"chinese_sky",chrome:"ancient_stone",winFX:"dragon_burst", coins:["\uD83C\uDFEF","\uD83D\uDC09","\u2728","\uD83D\uDCB0"],       anticipation:"dragon_glow", intro:"ancient" ,accentColor:"#50C878",reelStyle:"elastic",ambientFx:"mist"},
    arctic_foxes:        { bgType:"blizzard",     chrome:"chrome_round", winFX:"frost_burst",  coins:["\uD83E\uDD8A","\u2744","\u2728","\uD83D\uDCB0"],             anticipation:"frost_glow",  intro:"frozen" ,accentColor:"#87CEEB",reelStyle:"flutter",ambientFx:"snow"},
    ...
    midnight_drifter:{ bgType:"city_rain",chrome:"tech_hud",winFX:"neon_pop",     coins:["\uD83C\uDFCE","\uD83C\uDF03","\u2728","\uD83D\uDCB0"],       anticipation:"electric",    intro:"neon" ,accentColor:"#0088FF",reelStyle:"wave",ambientFx:"smoke"},
    pharaoh_march:{ bgType:"egypt_tomb",chrome:"stone_aztec",winFX:"sand_burst",   coins:["\uD83C\uDFFA","\u2620","\u2728","\uD83D\uDCB0"],             anticipation:"sand_storm",  intro:"ancient" ,accentColor:"#DEB887",reelStyle:"smooth",ambientFx:"embers"},
    iron_stampede:       { bgType:"prairie",      chrome:"dark_iron",    winFX:"dust_cloud",   coins:["\uD83D\uDC0E","\u2694","\u2728","\uD83D\uDCB0"],             anticipation:"rumble",      intro:"dramatic" ,accentColor:"#808080",reelStyle:"smooth",ambientFx:"dust"},
    ...
    lightning_pearl:     { bgType:"ocean_ripple", chrome:"gem_frame",    winFX:"energy_pulse", coins:["\u26A1","\uD83D\uDC1A","\u2728","\uD83D\uDCB0"],             anticipation:"electric",    intro:"epic" ,accentColor:"#FFD700",reelStyle:"wave",ambientFx:"bubbles"},
    ...
    nova_blackhole:{ bgType:"starfield",chrome:"tech_hud",winFX:"energy_pulse", coins:["\uD83C\uDF0C","\u26A1","\u2728","\uD83D\uDCB0"],             anticipation:"cosmic_hum",    intro:"cosmic" ,accentColor:"#483D8B",reelStyle:"gravity",ambientFx:"stars"},
    ...
    dragon_forge:        { bgType:"volcano",      chrome:"fire_border",  winFX:"dragon_burst", coins:["\uD83D\uDC09","\uD83D\uDD25","\u2728","\uD83D\uDCB0"],       anticipation:"dragon_glow",        intro:"epic" ,accentColor:"#CC5500",reelStyle:"slam",ambientFx:"embers"},
    ...
    pixel_rewind:        { bgType:"retro_glow",   chrome:"arcade_neon",  winFX:"neon_pop",     coins:["\uD83D\uDC7E","\uD83C\uDFAE","\u2B50","\uD83D\uDCB0"],       anticipation:"neon_flash",    intro:"neon" ,accentColor:"#00FF00",reelStyle:"turbo",ambientFx:"confetti"},
    ...
    solar_fist:{ bgType:"flames",chrome:"gold_ornate",winFX:"solar_burst",  coins:["\u2600","\uD83E\uDD1C","\u26A1","\uD83D\uDCB0"],             anticipation:"heat",        intro:"epic" ,accentColor:"#FFA500",reelStyle:"slam",ambientFx:"embers"},
    ...
    clockwork_realm:     { bgType:"cyber_grid",   chrome:"tech_hud",     winFX:"energy_pulse", coins:["\u2699","\uD83D\uDD70","\u2728","\uD83D\uDCB0"],             anticipation:"electric",    intro:"cyber" ,accentColor:"#B8860B",reelStyle:"glitch",ambientFx:"stars"},
    ...
    snow_queen_riches:   { bgType:"blizzard",     chrome:"gem_frame",    winFX:"frost_burst",  coins:["\u2744","\uD83D\uDC51","\uD83D\uDC8E","\uD83D\uDCB0"],       anticipation:"frost_glow",  intro:"frozen" ,accentColor:"#E0FFFF",reelStyle:"gravity",ambientFx:"aurora"},
    ...
    golden_vault_pharaoh:{ bgType:"egypt_dusk",chrome:"gold_ornate",winFX:"sand_burst",   coins:["\uD83C\uDFFA","\uD83D\uDCB0","\uD83D\uDC8E","\u2728"],       anticipation:"sand_storm",  intro:"ancient" ,accentColor:"#B8860B",reelStyle:"smooth",ambientFx:"sand"},
    mythic_olympiad:{ bgType:"olympus",chrome:"ancient_stone",winFX:"lightning_strike",coins:["\uD83C\uDFDB","\u26A1","\uD83D\uDC8E","\uD83D\uDCB0"], anticipation:"thunder",     intro:"ancient" ,accentColor:"#DAA520",reelStyle:"thunder_drop",ambientFx:"stars"},
    neon_nexus:{ bgType:"neon_city",chrome:"arcade_neon",winFX:"energy_pulse", coins:["\uD83D\uDCBB","\u26A1","\u2728","\uD83D\uDCB0"],             anticipation:"neon_flash",    intro:"neon" ,accentColor:"#FF00FF",reelStyle:"flutter",ambientFx:"lightning"},
    anglers_fortune:     { bgType:"ocean_ripple", chrome:"fishing",      winFX:"splash",       coins:["\uD83D\uDC1F","\uD83C\uDFA3","\u2728","\uD83D\uDCB0"],       anticipation:"wave_crash",  intro:"watery" ,accentColor:"#4682B4",reelStyle:"wave",ambientFx:"bubbles"},
    mecha_warriors:{ bgType:"cyber_grid",chrome:"dark_iron",winFX:"gear_burst", coins:["\uD83E\uDD16","\u26A1","\uD83D\uDD25","\uD83D\uDCB0"],       anticipation:"electric",    intro:"cyber" ,accentColor:"#00FF88",reelStyle:"slam",ambientFx:"stars"},
    enchanted_grove:     { bgType:"enchanted",    chrome:"bamboo",       winFX:"magic_swirl",  coins:["\uD83C\uDF3F","\uD83E\uDDA5","\u2728","\uD83D\uDCB0"],       anticipation:"sparkle",     intro:"mystic" ,accentColor:"#50C878",reelStyle:"flutter",ambientFx:"sparkles"},
    dragons_hoard:{ bgType:"volcano",chrome:"gold_ornate",winFX:"dragon_burst", coins:["\uD83D\uDC09","\uD83D\uDCB0","\uD83D\uDC8E","\u2728"],       anticipation:"dragon_glow",        intro:"epic" ,accentColor:"#FF8C00",reelStyle:"slam",ambientFx:"embers"},
    time_keepers_book:{ bgType:"enchanted",chrome:"gold_ornate",winFX:"magic_swirl",  coins:["\uD83D\uDD70","\uD83D\uDCD6","\u2728","\uD83D\uDCB0"],       anticipation:"cosmic_hum",     intro:"mystic" ,accentColor:"#4169E1",reelStyle:"flutter",ambientFx:"sparkles"},
    cyber_rebellion:{ bgType:"neon_city",chrome:"tech_hud",winFX:"glitch_burst", coins:["\uD83E\uDD16","\uD83D\uDCA5","\u26A1","\uD83D\uDCB0"],       anticipation:"electric",    intro:"cyber" ,accentColor:"#39FF14",reelStyle:"glitch",ambientFx:"confetti"},
    ...
    sunken_treasure:{ bgType:"ocean_ripple",chrome:"pirate_wood",winFX:"treasure_pop",       coins:["\uD83D\uDC1A","\uD83D\uDCB0","\u2693","\u2728"],             anticipation:"wave_crash",  intro:"watery" ,accentColor:"#20B2AA",reelStyle:"wave",ambientFx:"bubbles"},
    wild_stallion:{ bgType:"prairie",chrome:"dark_iron",winFX:"thunder_burst",   coins:["\uD83D\uDC0E","\uD83C\uDF1E","\u2B50","\uD83D\uDCB0"],       anticipation:"rumble",      intro:"dramatic" ,accentColor:"#8B4513",reelStyle:"smooth",ambientFx:"dust"},
    celestial_cosmos:    { bgType:"cosmos",       chrome:"gem_frame",    winFX:"starburst",    coins:["\uD83C\uDF0C","\u2728","\uD83C\uDF1F","\uD83D\uDCB0"],       anticipation:"cosmic_hum",   intro:"cosmic" ,accentColor:"#6A5ACD",reelStyle:"flutter",ambientFx:"aurora"},
    jade_prosperity:{ bgType:"chinese_sky",chrome:"jade_frame",winFX:"starburst", coins:["\uD83C\uDFEF","\uD83D\uDCB0","\uD83D\uDC8E","\u2728"],       anticipation:"golden_aura", intro:"mystic" ,accentColor:"#50C878",reelStyle:"elastic",ambientFx:"fireflies"},
