...
const TABLES = [
    ...
    // Route-based battle pass (battle-pass.routes.js, keyed by battle_passes.id) — kept
    // separate from the service's season-based battle_pass_progress above. Mirror schema-pg.js.
...
const INDEXES = [
    ...
    // Previously: bonus cap check scanned full transactions table on every bonus claim.
    // Spin queries scanned full spins table for daily progress/achievements.
